...
static MaterialProperties* NewMaterialPropertices(const MaterialProperties& _props)
{
...
Material::Material(const MaterialProperties& _materialProperties /*= MaterialProperties()*/)
	:m_MaterialProperties(NewMaterialPropertices(_materialProperties), &DeleteMaterialProperties)
{}

Material::Material(const Material& _copy)
	:m_MaterialProperties(NewMaterialPropertices(*_copy.m_MaterialProperties), &DeleteMaterialProperties),
...
void Material::SetTexture(TextureType type, std::shared_ptr<Texture> texture)
{
	...
	{
		m_MaterialProperties->HasORMTexture = (texture != nullptr);
	}
	break;
